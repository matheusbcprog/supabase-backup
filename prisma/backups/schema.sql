...
\restrict 6CUq1dn6GH9eU8XGdynG8DgcjdlaFy45yS1Ldsg9owwMPe4tm98Pzgrs7VhOg3K
...
--
-- Name: imagens_drive; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.imagens_drive (
    id integer NOT NULL,
    nome text NOT NULL,
...
ALTER TABLE public.imagens_drive OWNER TO postgres;

--
-- Name: imagens_drive_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.imagens_drive_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.imagens_drive_id_seq OWNER TO postgres;

--
-- Name: imagens_drive_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.imagens_drive_id_seq OWNED BY public.imagens_drive.id;
...
--
-- Name: user_instances; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: user_instances_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.user_instances_id_seq OWNER TO postgres;

--
-- Name: user_instances_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: imagens_drive id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.imagens_drive ALTER COLUMN id SET DEFAULT nextval('public.imagens_drive_id_seq'::regclass);
...
--
-- Name: user_instances id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: imagens_drive imagens_drive_drive_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.imagens_drive
    ADD CONSTRAINT imagens_drive_drive_id_key UNIQUE (drive_id);


--
-- Name: imagens_drive imagens_drive_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.imagens_drive
    ADD CONSTRAINT imagens_drive_pkey PRIMARY KEY (id);
...
--
-- Name: user_instances user_instances_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_user_instances_user_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_user_instances_user_id ON public.user_instances USING btree (user_id);
...
--
-- Name: financial_categories financial_categories_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.transactions
    ADD CONSTRAINT transactions_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.dados_cliente(id) ON DELETE SET NULL;
...
--
-- Name: user_instances user_instances_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: financial_categories Allow users to manage their own categories; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow users to manage their own categories" ON public.financial_categories USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));


--
-- Name: payment_methods Allow users to manage their own payment methods; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow users to manage their own payment methods" ON public.payment_methods USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));


--
-- Name: reminders Users can create their own reminders; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: financial_transactions Users can delete their own financial transactions; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reminders Users can delete their own reminders; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: webhook_configurations Users can delete their own webhook configurations; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can delete their own webhook configurations" ON public.webhook_configurations FOR DELETE USING ((auth.uid() = user_id));
...
--
-- Name: financial_transactions Users can insert their own financial transactions; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can insert their own financial transactions" ON public.financial_transactions FOR INSERT WITH CHECK ((auth.uid() = user_id));


--
-- Name: webhook_configurations Users can insert their own webhook configurations; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can insert their own webhook configurations" ON public.webhook_configurations FOR INSERT WITH CHECK ((auth.uid() = user_id));


--
-- Name: transactions Users can manage their own transactions; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can manage their own transactions" ON public.transactions USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));


--
-- Name: clients Users can select their own clients; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: financial_transactions Users can select their own financial transactions; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can select their own financial transactions" ON public.financial_transactions FOR SELECT USING ((auth.uid() = user_id));


--
-- Name: webhook_configurations Users can select their own webhook configurations; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can select their own webhook configurations" ON public.webhook_configurations FOR SELECT USING ((auth.uid() = user_id));
...
--
-- Name: financial_transactions Users can update their own financial transactions; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reminders Users can update their own reminders; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: webhook_configurations Users can update their own webhook configurations; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can update their own webhook configurations" ON public.webhook_configurations FOR UPDATE USING ((auth.uid() = user_id));


--
-- Name: reminders Users can view their own reminders; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: webhook_configurations; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: objects Permitir upload para autenticados; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Permitir upload para autenticados" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'landing'::text));
...
CREATE POLICY "Users can delete their own documents" ON storage.objects FOR DELETE USING (((auth.uid() = owner) AND (bucket_id = 'documents'::text)));
...
CREATE POLICY "Users can update their own documents" ON storage.objects FOR UPDATE USING (((auth.uid() = owner) AND (bucket_id = 'documents'::text)));
...
CREATE POLICY "Users can upload their own documents" ON storage.objects FOR INSERT WITH CHECK (((auth.uid() = owner) AND (bucket_id = 'documents'::text)));
...
CREATE POLICY "Users can view their own documents" ON storage.objects FOR SELECT USING ((auth.uid() = owner));
...
--
-- Name: objects geral vmbdr4_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "geral vmbdr4_0" ON storage.objects FOR INSERT WITH CHECK ((bucket_id = 'imagens'::text));


--
-- Name: objects geral vmbdr4_1; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "geral vmbdr4_1" ON storage.objects FOR SELECT USING ((bucket_id = 'imagens'::text));


--
-- Name: objects geral vmbdr4_2; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "geral vmbdr4_2" ON storage.objects FOR DELETE USING ((bucket_id = 'imagens'::text));


--
-- Name: objects geral vmbdr4_3; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "geral vmbdr4_3" ON storage.objects FOR UPDATE USING ((bucket_id = 'imagens'::text));
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.agendamentos TO anon;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.agendamentos TO authenticated;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.agendamentos TO service_role;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.dados_cliente TO anon;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.dados_cliente TO authenticated;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.dados_cliente TO service_role;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.financial_categories TO anon;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.financial_categories TO authenticated;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.financial_categories TO service_role;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.financial_transactions TO anon;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.financial_transactions TO authenticated;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.financial_transactions TO service_role;


--
-- Name: TABLE imagens_drive; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.imagens_drive TO anon;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.imagens_drive TO authenticated;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.imagens_drive TO service_role;


--
-- Name: SEQUENCE imagens_drive_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.imagens_drive_id_seq TO anon;
GRANT ALL ON SEQUENCE public.imagens_drive_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.imagens_drive_id_seq TO service_role;


--
-- Name: TABLE landing_content; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.landing_content TO anon;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.landing_content TO authenticated;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.landing_content TO service_role;
...
--
-- Name: TABLE user_instances; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.user_instances TO anon;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.user_instances TO authenticated;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.user_instances TO service_role;


--
-- Name: SEQUENCE user_instances_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.user_instances_id_seq TO anon;
GRANT ALL ON SEQUENCE public.user_instances_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.user_instances_id_seq TO service_role;


--
-- Name: TABLE webhook_configurations; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.webhook_configurations TO anon;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.webhook_configurations TO authenticated;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.webhook_configurations TO service_role;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_04 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_04 TO dashboard_user;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_05 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_05 TO dashboard_user;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_06 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_06 TO dashboard_user;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_07 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_07 TO dashboard_user;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_08 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_08 TO dashboard_user;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_09 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_09 TO dashboard_user;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_10 TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE realtime.messages_2025_07_10 TO dashboard_user;
...
\unrestrict 6CUq1dn6GH9eU8XGdynG8DgcjdlaFy45yS1Ldsg9owwMPe4tm98Pzgrs7VhOg3K
